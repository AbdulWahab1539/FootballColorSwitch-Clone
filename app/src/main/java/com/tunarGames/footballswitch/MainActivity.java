...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageView footballImageView;
...
/*
        ...
        RotateAnimation ballrotate = new RotateAnimation(0, 360, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
